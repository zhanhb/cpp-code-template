...
namespace Moya {
    ...
    class MemoryPool {
        ...
        public:
            ...
            explicit Buffer(Buffer *next) : next(next) {}
    ...
    public:
        ...
        template<class U>
        [[maybe_unused]] explicit Allocator(const Allocator<U, growSize> &other) {
        ...
        void construct(_Up *p, Args &&... args) { ::new((void *) p) _Up(std::forward<Args>(args)...); }
