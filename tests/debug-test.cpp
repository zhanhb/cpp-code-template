...
int main() {
    ...
    STATIC_ASSERT_V(debug::is_adapter, array_adapter);
    STATIC_ASSERT_NOT_V(debug::is_adapter, incompatible_adapter);
    STATIC_ASSERT_NOT_V(debug::is_adapter, contain_type_only_adapter);
    STATIC_ASSERT_NOT_V(debug::is_adapter, c_only_adapter);
    STATIC_ASSERT_V(debug::is_adapter, custom_adapter);
    STATIC_ASSERT_NOT_V(debug::is_adapter, not_container_adapter);
    STATIC_ASSERT_V(debug::is_adapter, extends_queue);
    STATIC_ASSERT_NOT_V(debug::is_adapter, final_adapter);
    STATIC_ASSERT_V(debug::is_adapter, final_adapter_exposed_c);
    STATIC_ASSERT_NOT_V(debug::is_adapter, private_adapter);
    STATIC_ASSERT_NOT_V(debug::is_adapter, protected_adapter);
    STATIC_ASSERT_NOT_V(debug::is_adapter, private_c_adapter);
    STATIC_ASSERT_NOT_V(debug::is_adapter, static_c_adapter);
    STATIC_ASSERT_V(debug::is_adapter, std::queue<int>);
    STATIC_ASSERT_V(debug::is_adapter, std::queue<int> &);
    STATIC_ASSERT_V(debug::is_adapter, const std::queue<int> &);
    STATIC_ASSERT_V(debug::is_adapter, std::queue<int> &&);
    STATIC_ASSERT_V(debug::is_collection, std::string);
#if __cpp_lib_string_view
    STATIC_ASSERT_V(debug::is_collection, std::string_view);
    STATIC_ASSERT_V(utility::is_string_of, std::string_view, char);
    STATIC_ASSERT_V(utility::is_string_of, std::wstring_view, wchar_t);
    STATIC_ASSERT_V(debug::is_string, std::string_view);
    STATIC_ASSERT_V(debug::is_string, std::string_view &);
    STATIC_ASSERT_V(debug::is_string, std::string_view &&);
    STATIC_ASSERT_V(debug::is_string, std::wstring_view);
    STATIC_ASSERT_V(debug::is_string, std::wstring_view &);
    STATIC_ASSERT_V(debug::is_string, std::wstring_view &&);
#endif
    STATIC_ASSERT_V(utility::is_string_of, std::string, char);
    STATIC_ASSERT_V(utility::is_string_of, std::wstring, wchar_t);
    STATIC_ASSERT_V(debug::is_string, std::string);
    STATIC_ASSERT_V(debug::is_string, std::string &);
    STATIC_ASSERT_V(debug::is_string, std::string &&);
    STATIC_ASSERT_V(debug::is_string, std::wstring);
    STATIC_ASSERT_V(debug::is_string, std::wstring &);
    STATIC_ASSERT_V(debug::is_string, std::wstring &&);
    STATIC_ASSERT_V(debug::is_string, const char*);
    STATIC_ASSERT_V(debug::is_string, const wchar_t[10]);
    STATIC_ASSERT_V(debug::is_collection, std::valarray<int>);
    STATIC_ASSERT_V(debug::is_collection, std::vector<int>);
    STATIC_ASSERT_V(debug::is_collection, std::vector<int> &);
    STATIC_ASSERT_V(debug::is_collection, std::vector<int> &&);
    STATIC_ASSERT_V(debug::is_collection, const std::vector<int>);
    STATIC_ASSERT_V(debug::is_collection, const std::vector<int> &);
    STATIC_ASSERT_NOT_V(debug::is_map, falsy_fake_map);
    STATIC_ASSERT_V(debug::is_map, fake_map);
    STATIC_ASSERT_V(debug::is_map, std::map<int, int>);
    STATIC_ASSERT_V(debug::is_map, std::map<int, int> &);
    STATIC_ASSERT_V(debug::is_map, std::map<int, int> &&);
    STATIC_ASSERT_V(debug::is_map, const std::map<int, int>);
    STATIC_ASSERT_NOT_V(debug::is_map, private_map);
    STATIC_ASSERT_V(debug::is_map, smallest_map);
    STATIC_ASSERT_V(debug::is_map, std::multimap<int, int>);
    STATIC_ASSERT_V(debug::is_map, std::unordered_map<int, int> &&);
    STATIC_ASSERT_V(debug::is_tuple, std::tuple<>);
    STATIC_ASSERT_V(debug::is_tuple, std::tuple<> &&);
    STATIC_ASSERT_V(debug::is_tuple, const std::pair<int, int>&);
}
